...
All papers the group has read, is reading, or plans to read. Keep the table updated
as you work through papers. Add notes inline or link to a longer write-up in
...
| Badge | Meaning |
|---|---|
| To Read | On our list but not yet started |
| Reading | Actively being read by someone |
| Read | Finished (and summarised?) |
| Referenced | Cited in our work / used as background |
...
=== "To Read"
    ...
    |---|---|---|---|
    | [Online Graph Edge-Coloring in the Random-Order Arrival Model](https://theoryofcomputing.org/articles/v008a025/v008a025.pdf) | Bahmani, Mehta, Motwani | 2012 | Try to see if we can help solve Conjecture 3.12 |
    | [aristotle](https://aristotle.harmonic.fun/) | aristotle | N/A | Formal Reasoning Agent |
    | [Solving an Open Problem in Theoretical Physics using AI-Assisted Discovery](https://arxiv.org/abs/2603.04735) | Brenner, et al. | 2026 | Agent math in physics |
...
=== "Reading"
    ...
    | Title | Authors | Year | Notes |
    |---|---|---|---|
    | [SHORT PROOFS IN COMBINATORICS, PROBABILITY AND NUMBER THEORY II](https://arxiv.org/pdf/2604.06609) | Alexeev, et al. | 2026 | Collection of **Erdős Problems** we are considering to help solve |
    | [AlphaEvolve](https://deepmind.google/blog/alphaevolve-a-gemini-powered-coding-agent-for-designing-advanced-algorithms/) | Google | 2026 | Google's AI Agent currently helping to make progress in algorithm discovery and optimization |
...
=== "Read"
    ...
    | [Optimal Online Discrepancy Minimization in Linear Time](https://arxiv.org/pdf/2607.04388v1) | Ishaq Aden-Ali | 2026 | Interesting, argument clever and well presented |
...
Add a new row to the table in the correct tab above:

```markdown
| [Title](URL) | Authors | Year | Notes |
```

Where `URL` is the arXiv link, DOI, or PDF URL.

---

## Useful Search Resources

- **[arXiv cs.CC / cs.DS / math.CO](https://arxiv.org/)** — preprints in complexity, algorithms, combinatorics
- **[Semantic Scholar](https://www.semanticscholar.org/)** — citation search and "related papers" graph
- **[Connected Papers](https://www.connectedpapers.com/)** — visualise the citation neighbourhood of a paper
- **[ECCC](https://eccc.weizmann.ac.il/)** — Electronic Colloquium on Computational Complexity
- **[DBLP](https://dblp.org/)** — comprehensive CS bibliography
